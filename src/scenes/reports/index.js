...
import { useAuthData } from "../../services/users/useAuthData";
import { getDateTime } from "../../utils/utils";

const Reports = () => {
    const adminData = useAuthData();
    console.log("admin: ", adminData);

    const { reports } = useContext(ReportsContext);
    const [selectedYear, setSelectedYear] = useState(2023);
    const [selectedMonth, setSelectedMonth] = useState(""); // jan - march only, 1 = january, 2 = feb and so on
                    ...
                    >
                        ...
                        <Button
                            ...
                            onClick={() => {
                                exportPdfChart(
                                    "yearly-chart-id",
                                    `Yearly Reports of Fire Incident in Antipolo City (${getDateTime()})`,
                                    adminData.fullName
                                );
                            }}
                        >
